<?php require_once 'inc/header.php'; ?>
    ...
    <div class="page-content">
        ...
        <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
          <div>
            <h4 class="mb-3 mb-md-0">Bienvenue, vous</h4>
          </div>
        </div>
        <div class="row">
...
<div class="tiles">
<div class="tile bg-grey-salsa">
<div class="tile-body">
<i class="fa fa-signal"></i>
</div>
<div class="tile-object">
<div class="name"> En ligne </div>
<div class="number" id="setEtatTel"><i class="fa fa-check"></i></div>
</div>
</div>
<div class="tile bg-red-intense">
<div class="tile-body" id="setLevelBat"><i class="fa fa-battery-half"></i></div>
<div class="tile-object">
<div class="name"> Batterie </div>
<div class="number" id="setLevel">50 %</div>
</div>
</div>
<div id="locationOpenMap" class="tile double bg-blue-madison">
<div class="tile-body">
<i style="float: left; margin-right: 10px; margin-top: 0px;" class="fa fa-map-o"></i>
<h4>Localisation</h4>
<p class="number" style="padding-top: 5px;" id="setGPS">Chicago, Illinois, Etats-Unis </p>
</div>
<div id="lastTimeLocation" class="tile-object" style="">
<div class="name"> Dernière localisation </div>
<div id="lastTimeLocationData" class="number" style="font-weight: 300;font-size: 12px;">14/01/2019 12:38:02</div>
</div>
</div>
</div>
</div>
        ...
        <div class="row">
          ...
          <div class="col-lg-7 col-xl-8 stretch-card">
            <div class="card">
              <div class="card-body">
                <div class="d-flex justify-content-between align-items-baseline mb-2">
                  <h6 class="card-title mb-0">Dernière Appeles</h6>
                  <div class="dropdown mb-2">
